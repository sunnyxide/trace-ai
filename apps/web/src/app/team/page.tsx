...
const TEAM: Founder[] = [
  {
    ...
    links: [
      { label: 'Email',        href: 'mailto:sunny@tryorbt.com' },
      { label: 'Book a call',  href: 'mailto:sunny@tryorbt.com?subject=trace.ai%20%E2%80%94%20intro%20call' },
    ],
    tone: 'brand',
    initials: 'MK',
  },
  {
    ...
    links: [
      { label: 'Email',        href: 'mailto:sunwo1224@korea.ac.kr' },
      { label: 'Book a call',  href: 'mailto:sunwo1224@korea.ac.kr?subject=trace.ai%20%E2%80%94%20intro%20call' },
    ],
    tone: 'ink',
    initials: 'SJ',
  },
