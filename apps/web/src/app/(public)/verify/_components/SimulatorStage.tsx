  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <path
            d="M 12 30 C 80 10, 140 50, 220 22 S 380 14, 460 32"
            stroke="var(--ll-brand)"
            strokeWidth="2"
            fill="none"
            strokeLinecap="round"
            ...
            style={{
              animation: 'sign-trace 1.6s cubic-bezier(.4,0,.2,1) 200ms both',
            }}
          />
          <circle cx="460" cy="32" r="6" fill="var(--ll-brand)">
            <animate
              attributeName="r"
              values="0;0;6;6;8;6"
              keyTimes="0;0.6;0.7;0.85;0.92;1"
              dur="2.2s"
              fill="freeze"
              begin="0s"
            />
